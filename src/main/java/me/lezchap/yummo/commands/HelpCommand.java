...
public class HelpCommand {
    ...
    public static boolean showHelp(CommandSender sender, String[] args){
        if (sender.hasPermission("yummo.help")) {
            ...
            sender.sendMessage(ChatColor.YELLOW + "/yummo maxfood [#] - shows or [optionally] changes the MaxFood setting for Yummo Helms");
            ...
            sender.sendMessage(ChatColor.YELLOW + "/yummo <player> <type> [color] - Gives player a Yummo Helm of the designated type.");
            sender.sendMessage(ChatColor.YELLOW + "   Valid Types: Netherite, Diamond, Gold, Iron, Chain, and Leather.");
